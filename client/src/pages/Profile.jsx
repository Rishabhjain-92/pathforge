            ...
            <div style={{ width: "100%", display: "flex", flexDirection: "column", gap: "10px" }}>
              {[
                ...
                <div key={stat.label} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "10px 14px", backgroundColor: "#1F2937", borderRadius: "10px" }}>
                  ...
                  <span style={{ color: stat.color, fontSize: "13px", fontWeight: "600", maxWidth: "120px", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                    {stat.value}
                  </span>
                </div>
              ))}
            ...
            <div style={{ width: "100%", marginTop: "20px" }}>
              <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "8px" }}>
                ...
                <span style={{ color: "#F97316", fontSize: "13px", fontWeight: "600" }}>
                  {Math.min(100, [
                    formData.name, formData.targetRole,
                    formData.targetCompany, formData.skills.length > 0
                  ...
                  {formData.skills.map((skill) => (
                    ...
                    >
                      ...
                      <button
                        ...
                        style={{ background: "none", border: "none", cursor: "pointer", color: "#FB923C", display: "flex", alignItems: "center", padding: 0 }}
                      >
                        <X size={13} />
                      </button>
                    </motion.span>
