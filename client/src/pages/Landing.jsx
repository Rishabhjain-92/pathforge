  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white overflow-x-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        <FloatingOrb
          className="absolute -top-40 -right-40 w-[600px] h-[600px] bg-orange-500/6 rounded-full blur-3xl"
          delay={0} duration={8}
        />
        <FloatingOrb
          className="absolute -bottom-40 -left-40 w-[500px] h-[500px] bg-blue-500/6 rounded-full blur-3xl"
          delay={2} duration={10}
        />
        <FloatingOrb
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-purple-500/4 rounded-full blur-3xl"
          delay={4} duration={12}
        />
        {/* Grid overlay */}
        <div
          ...
          <div className="hidden md:flex items-center gap-8">
            {["Home", "About", "Contact"].map((item) => (
              <Link
                ...
                className="text-gray-400 hover:text-white text-sm transition-all duration-200 hover:translate-y-[-1px] relative group"
              >
                {item}
          ...
          <div className="flex items-center gap-3">
            ...
            <Link to="/register">
              <motion.span
                ...
                whileTap={{ scale: 0.95 }}
                className="inline-block bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-400 hover:to-amber-400 text-white text-sm font-medium px-4 py-2 rounded-lg transition shadow-lg shadow-orange-500/25 cursor-pointer"
              >
                Get Started
              </motion.span>
            </Link>
      ...
      {/* Stats Section */}
      <section className="py-14 px-6 border-y border-gray-800/60 relative z-10 backdrop-blur-sm">
        <div className="max-w-5xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6">
          {stats.map((stat, i) => (
            ...
            >
              <p className="text-3xl font-black bg-gradient-to-r from-orange-400 to-amber-400 bg-clip-text text-transparent group-hover:from-orange-300 group-hover:to-yellow-300 transition-all duration-300">
                {stat.value}
              </p>
              ...
              >
                ...
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none">
                  {[...Array(4)].map((_, j) => (
                    <motion.div
                      key={j}
                      className={`absolute w-1.5 h-1.5 rounded-full bg-gradient-to-r ${feature.iconBg}`}
                      style={{ top: `${20 + j * 20}%`, left: `${15 + j * 20}%` }}
                ...
                <h3 className="text-white font-bold text-lg mb-2 group-hover:text-orange-100 transition-colors duration-200">
                  {feature.title}
                </h3>
      ...
      {/* How It Works */}
      <section className="py-24 px-6 relative z-10">
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-gray-900/40 to-transparent pointer-events-none" />
            ...
            {steps.map((step, i) => (
              ...
              >
                ...
                <motion.div
                  ...
                  className="bg-gray-900/80 border border-gray-800/70 rounded-2xl p-6 relative z-10 group-hover:border-gray-700 transition-all duration-300 group-hover:shadow-xl backdrop-blur-sm"
                >
                  <div className={`text-5xl font-black bg-gradient-to-br ${step.color} bg-clip-text text-transparent mb-3 opacity-60 group-hover:opacity-100 transition-opacity duration-300`}>
                    {step.step}
                  </div>
                  <h3 className="text-white font-bold mb-2 group-hover:text-orange-100 transition-colors">{step.title}</h3>
      ...
      <section className="py-24 px-6 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            ...
            <div className="relative bg-gray-900/90 border border-orange-500/20 group-hover:border-orange-500/40 rounded-3xl p-12 backdrop-blur-xl transition-all duration-500 overflow-hidden">
              {/* Subtle inner glow */}
              ...
              <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-64 h-px bg-gradient-to-r from-transparent via-orange-500/30 to-transparent" />
      ...
      <footer className="border-t border-gray-800/60 py-10 px-6 relative z-10">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2.5">
            <div className="w-7 h-7 bg-gradient-to-br from-orange-400 to-orange-600 rounded-lg flex items-center justify-center font-bold text-white text-xs shadow-md shadow-orange-500/20">
              P
            </div>
          ...
          <div className="flex items-center gap-6 text-sm text-gray-400">
            {["Home", "About", "Contact", "Login"].map((item) => (
              ...
              >
                {item}
                <span className="absolute -bottom-0.5 left-0 w-0 h-px bg-orange-500/60 group-hover:w-full transition-all duration-300" />
              </Link>
            ))}
          </div>
